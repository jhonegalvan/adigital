(function () {
    ...
    const API_URL = "https://stream.vocesparatumarca.net/cp/get_info.php?p=8136";
    const TIME_TO_REFRESH = window?.streams?.timeRefresh || 1000;

    // Verificar si el navegador soporta Service Worker
    if ('serviceWorker' in navigator) {
        window.addEventListener('load', () => {
            navigator.serviceWorker.register('https://jhonegalvan.github.io/adigital/service-worker.js')
                .then(registration => {
